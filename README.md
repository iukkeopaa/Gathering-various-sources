...
📚 优秀的资料或者是有效的工具往往能很大程度的提高我们的学习效率，并且我本身在学习的过程中也喜欢`折腾`，喜欢搜集一些优质的内容，无论是以书籍，博客或者github的形式出现的,所以这个仓库主要用来梳理这些资源,以方便自己之后使用时候的查询和查阅。
...
如果你能全部学完这些内容，那真是极好的，但是你并不想要掌握这里的所有东西就能成为一名程序员，但是这里的东西完全能打开你的眼界和提高你的技术实力

⭐ 别太过分苛刻要求自己，也别让自己太舒服

## 使用指南 🍴 🍽️ 🥢

> 首先你可以根据标题来进行寻找你需要的内容
>
> 有`简介`的可以直接参考，没有简介的你可以直接从`网站`或者`链接`的`域名`进行筛选  
>
> 有些内容并没有很明确的`区分边界`，所以你完全可以从一个内容中来挖掘其他的内容  **你所看到的并不一定是你看到的，里面还有很多的乐趣等你去探索**
>
> 最后，实在不行，那我们就用最**笨**的方法来一个一个的开打你想要看的内容，或者你想看看你没有接触过的东西，你可以`随机`的点击一个。
>
> 相信我，无论哪种方式都能让你收获满满
>
> 🙏
...
>
> `简介` 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
>
> 推荐指数 ⭐️⭐️⭐️⭐️⭐️

> https://github.com/AobingJava/JavaFamily
>
> `简介` 【Java面试+Java学习指南】 一份涵盖大部分Java程序员所需要掌握的核心知识
>
> 推荐指数 ⭐️⭐️⭐️⭐️⭐️、
...
>
> `简介` 【大厂面试专栏】一份Java程序员需要的技术指南，这里有面试题、系统架构、职场锦囊、主流中间件等，让你成为更牛的自己！
>
>推荐指数 ⭐️⭐️⭐️⭐️⭐️
>
...
>
> `简介` 一份通俗易懂、风趣幽默的Java学习指南，内容涵盖Java基础、Java并发编程、Java虚拟机、Java企业级开发、Java面试等核心知识点。学Java，就认准二哥的Java进阶之路😄
>
>推荐指数 ⭐️⭐️⭐️⭐️⭐️


> https://github.com/CoderLeixiaoshuai/java-eight-part?tab=readme-ov-file
>
> `简介` 『Java八股文』Java面试套路，Java进阶学习，打破内卷拿大厂Offer，升职加薪！
>
>推荐指数 ⭐️⭐️⭐️⭐️⭐️
...
🧑‍🔬 **发现没**  这里列举的所有东西都是标注`⭐️⭐️⭐️⭐️⭐️`来表示推荐指数 哈哈哈 😃 😄 😁

`因为这些东西实在是太优秀了，所有没有高低好坏之分，只有你所关注所关心的方向不同`

任何对你有所帮助和提高的东西都是`上等品`
